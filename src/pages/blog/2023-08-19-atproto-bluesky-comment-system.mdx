...
[Discus](https://disqus.com/) was out of the question for reasons of privacy and tracking.

Research suggested that [Isso](https://isso-comments.de/) was a good option.
Isso [solved a lot of the problems](/blog/2016-05-03-isso-a-lightweight-privacy-minded-comment-system) I had with Discus.
